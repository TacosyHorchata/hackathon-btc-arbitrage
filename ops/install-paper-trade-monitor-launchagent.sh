...
LABEL="com.pedro.hackathonbtc.paper-trade-monitor"
RUNTIME_DIR="$HOME/Library/Application Support/hackathon-btc"
LOG_DIR="$HOME/Library/Logs/hackathon-btc"
AGENT_DIR="$HOME/Library/LaunchAgents"

mkdir -p "$RUNTIME_DIR/paper_trades" "$LOG_DIR" "$AGENT_DIR"

cp "$ROOT_DIR/scripts/profit_monitor.py" "$RUNTIME_DIR/profit_monitor.py"
cp "$ROOT_DIR/scripts/profit_paper_trade_monitor.py" "$RUNTIME_DIR/profit_paper_trade_monitor.py"
chmod 644 "$RUNTIME_DIR/profit_monitor.py" "$RUNTIME_DIR/profit_paper_trade_monitor.py"
