...
LABEL="com.pedro.hackathonbtc.btc-hot-path"
RUNTIME_DIR="$HOME/Library/Application Support/hackathon-btc"
LOG_DIR="$HOME/Library/Logs/hackathon-btc"
AGENT_DIR="$HOME/Library/LaunchAgents"

mkdir -p "$RUNTIME_DIR/btc_hot_path" "$LOG_DIR" "$AGENT_DIR"

cp "$ROOT_DIR/scripts/btc_hot_path_monitor.py" "$RUNTIME_DIR/btc_hot_path_monitor.py"
chmod 644 "$RUNTIME_DIR/btc_hot_path_monitor.py"
